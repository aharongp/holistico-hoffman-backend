...
export interface PatientMedicalAttachmentWithPatient
  extends PatientMedicalAttachment {
...
export interface PatientDentalExam {
  id: number;
  patientId: number | null;
  createdAt: string | null;
  updatedAt: string | null;
...
export interface PatientDentalPresenceExam {
  id: number;
  patientId: number | null;
  createdAt: string | null;
  updatedAt: string | null;
